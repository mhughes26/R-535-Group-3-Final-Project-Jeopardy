...
The decade of the '90s was the mostly commonly referenced overall. 

24% of all Jeopardy answers contained a year, with 1% of those being 1996. 

Spikes on the graphs are seen at years ending in 0; many clues reference 
years by the decade or century only. 
```{r}
library(flexdashboard)
library(tidyverse)
...
=======
  slice(1:10) 
>>>>>>> dbbb711fa754a6ed367832c0c534bba454bf3ca1
...
reference_plot <- 
  ...
  ggtitle("Four digit years found in Jeopardy clues,Season 1-35",
          ...
          red line @1996:debut of jeopardy")+
  theme_few()
